...
public interface InnodbBufferPageMapper {
    @Insert({
        ...
        "values (#{POOL_ID,jdbcType=BIGINT}, #{BLOCK_ID,jdbcType=BIGINT}, ",
        ...
        "#{PAGE_STATE,jdbcType=VARCHAR}, #{IO_FIX,jdbcType=VARCHAR}, ",
    ...
    @Results({
        ...
        @Result(column="BLOCK_ID", property="BLOCK_ID", jdbcType=JdbcType.BIGINT),
        ...
        @Result(column="PAGE_STATE", property="PAGE_STATE", jdbcType=JdbcType.VARCHAR),
